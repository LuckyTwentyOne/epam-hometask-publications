...
<div class="row">
	...
	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 columns">
		<ul class="contact">
			<li>
				<p>
					<i class="fa fa-map-marker" aria-hidden="true"></i>Ukraine, Kharkiv
				</p>
			</li>
			<li>
				<p>
					<i class="fa fa-phone" aria-hidden="true"></i><a href="tel:+380504402216">+380504402216</a>
				</p>
			</li>
			<li>
				<p>
					<i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:vbutov91@gmail.com">vbutov91@gmail.com</a>
				</p>
			</li>
		</ul>
	</div>
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-3 columns">
		...
		<ul class="inline-list social no-bullet">
			...
			<li><a href="https://github.com/LuckyTwentyOne" target="_blank"><i class="fa fa-github" aria-hidden="true"></i></a></li>
		</ul>
	</div>
</div>